...
// TODO: Display the bio data from https://cs571api.cs.wisc.edu/rest/s26/ice/mascot
// TODO: Whenever a button is clicked, display the message from https://cs571api.cs.wisc.edu/rest/s26/ice/mascot-messages
export default function Mascot(props) {
    ...
    useEffect(() => {
        fetch("https://cs571api.cs.wisc.edu/rest/s26/ice/mascot", {
            headers: {
    ...
    function doSpeak() {
        fetch("https://cs571api.cs.wisc.edu/rest/s26/ice/mascot-messages", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        })
